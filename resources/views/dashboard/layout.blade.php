        ...
        <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div class="navbar-brand-wrapper d-flex justify-content-center">
                ...
                <div class="navbar-brand-inner-wrapper d-flex justify-content-between align-items-center w-100">
                    <a class="navbar-brand brand-logo" href="index.html"><img style="height: 150px;width: 300px"
                            class="mt-5" src="{{ asset('admin') }}/images/logo.svg" alt="logo" /></a>
                ...
                <footer class="footer">
                    <div class="d-sm-flex justify-content-center justify-content-sm-between">
                        <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © <a
                                href="https://www.bootstrapdash.com/" target="_blank">juneys.com </a>2023</span>
                        <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center">Telah Di Modifikasi
                            dari <a href="https://www.bootstrapdash.com/" target="_blank">Tempalate Bootstrap </a>
                        </span>
                    </div>
                </footer>
                <!-- partial -->
