...
class profileController extends Controller
{
    ...
    function update(Request $request) {
        $request->validate([
            ...
            '_foto.mimes' => 'Harap Upload Foto Terlebih Dahulu!',
            '_email.required' => 'Email wajib diisi!',
            '_email.email' => 'Harap Masukkan format email yang benar!'
        ]);
        ...
        if($request->hasFile('_foto')) {
            ...
            return redirect()->route('profile.index')->with('success', 'Berhasil Update Data Profil');
    }
}